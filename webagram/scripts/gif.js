    ...
    a.define('/gif.coffee', function(b, k, j, i) {
        ...
        d = a('events', b).EventEmitter, e = a('/browser.coffee', b), f = function(f, b, d) {
            ...
            return h(a, f), b = {
                ...
                if ('undefined' !== typeof CanvasRenderingContext2D && null != CanvasRenderingContext2D && b instanceof CanvasRenderingContext2D || 'undefined' !== typeof WebGLRenderingContext && null != WebGLRenderingContext && b instanceof WebGLRenderingContext) c.copy ? a.data = this.getContextData(b) : a.context = b;
